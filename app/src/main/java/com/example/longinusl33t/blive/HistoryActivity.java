...
public class HistoryActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.item_home) {
            ...
            Intent intent = new Intent(HistoryActivity.this, VipActivity.class);
            startActivity(intent);

        } else if (id == R.id.item_integration) {
            Intent intent = new Intent(HistoryActivity.this, IntegrationActivity.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(HistoryActivity.this, ConcernActivity.class);
            startActivity(intent);
